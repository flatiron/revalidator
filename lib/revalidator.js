(function (exports) {
  ...
  function error(attribute, property, actual, schema, errors) {
    var message = schema.message ? (typeof schema.message === 'string' ? schema.message : schema.message[attribute]) :
                  (validate.messages && validate.messages[property] || "no default message");
