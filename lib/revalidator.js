(function (exports) {
  ...
  function validateProperty(object, value, property, schema, options, errors) {
    ...
    function constrain(name, value, assert) {
      var result = assert(value, schema[name]);
      var message = typeof result === "string" ? result : null;
      if (schema[name] !== undefined && (message !== null || !result)) {
        error(name, property, value, schema, errors, message);
      }
    }
