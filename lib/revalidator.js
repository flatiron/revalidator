(function (exports) {
  ...
  validate.messages['notEnum'] = "must not be present in given enumerator";
  ...
  function validateProperty(object, value, property, schema, options, errors) {
    ...
    if (schema['notEnum'] && schema['notEnum'].indexOf(value) > -1 ) {
      error('notEnum', property, value, schema, errors);
    }
